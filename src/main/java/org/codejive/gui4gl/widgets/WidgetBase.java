...
public class WidgetBase implements Widget {
	...
	public void setParent(CompoundWidget _parent) {
		m_parent = _parent;
...
// FIXME: should handle padding!!
	...
	public void processKeyTypedEvent(GuiKeyEvent _event) {
	...
	public void processMouseMovedEvent(GuiMouseEvent _event) {
	...
	public WidgetRendererModel getRenderer() {
		return m_renderer;
	}

	public void setRenderer(WidgetRendererModel _renderer) {
	...
	protected void initWidget(RenderContext _context) {
		...
		if (renderer != null) {
			renderer.initRendering(_context);
		}
	}
