...
public class FixedPitchTextureFont implements Font {
	...
	public void renderText(RenderContext _context, String _sText) {
		final GL2 gl = _context.getGl();

		// get the current position
		gl.glGetIntegerv(GL2.GL_CURRENT_RASTER_POSITION, m_rasterPos, 0);
		...
		gl.glBindTexture(GL2.GL_TEXTURE_2D,  m_lTextureId);
...
//		gl.glColor4f(1f,1f,1f,1f);
		...
		gl.glAlphaFunc(GL2.GL_GREATER,0.1f); // Somehow this MUST BE .1f instead of 0f. (will get shadow effect when using 0f)  Need to check out why. 
